...
async def android_debug_list_devices() -> list[dict]:
...
async def android_debug_get_screen_data(params: DeviceSelector) -> dict:
    return service.get_screen_data(params.serial)
...
async def android_debug_dump_ui_hierarchy(params: HierarchyInput) -> dict:
    return service.dump_ui_hierarchy(params.serial)
...
async def android_debug_tap(params: TapInput) -> dict:
    return service.tap(
        params.serial,
        x=params.x,
        y=params.y,
...
async def android_debug_swipe(params: SwipeInput) -> dict:
...
async def android_debug_input_text(params: InputTextInput) -> dict:
    return service.input_text(params.serial, params.text)
...
async def android_debug_launch_app(params: LaunchAppInput) -> dict:
    return service.launch_app(params.serial, params.package_name)
...
async def android_debug_press_back(params: DeviceSelector) -> dict:
    return service.press_back(params.serial)
...
async def android_debug_press_home(params: DeviceSelector) -> dict:
    return service.press_home(params.serial)
...
async def android_debug_push_media_to_device(params: PushMediaInput) -> dict:
    return service.push_media_to_device(
        params.serial,
