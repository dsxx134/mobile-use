...
class FeishuBitableSource:
    ...
    def _record_to_listing_draft(self, record: dict[str, Any]) -> ListingDraft | None:
        ...
        return ListingDraft(
            ...
            original_price=self._get_optional_text_field(
                fields, self.settings.original_price_field_name
            ),
            stock=self._get_optional_text_field(fields, self.settings.stock_field_name),
            ...
            coin_discount=self._get_optional_text_field(
                fields, self.settings.coin_discount_field_name
            ),
            shipping_method=self._get_optional_text_field(
                fields, self.settings.shipping_method_field_name
            ),
            shipping_time=self._get_optional_text_field(
                fields, self.settings.shipping_time_field_name
            ),
