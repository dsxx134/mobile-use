...
- Original upstream repository retained as `https://github.com/minitap-ai/mobile-use.git`.
...
- Default push target is personal `origin`; the original repository should be treated as `upstream` unless permissions change.
